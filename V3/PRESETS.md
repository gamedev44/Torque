...
| `GIF_PATH` | String | File path | Path to the engine animation GIF file (relative to project root). |
...
| Engine | `GIF_PATH` | String | File path |
...
[Engine]
TYPE=v10
GIF_PATH=assets/V10-Firing.gif
